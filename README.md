...
- [Conhecendo as primeiras funções para criação de queries](day-2/README.md#conhecendo-as-primeiras-funções-para-criação-de-queries)
  - [A função rate](day-2/README.md#a-função-rate)
  - [A função irate](day-2/README.md#a-função-irate)
  - [A função delta](day-2/README.md#a-função-delta)
  - [A função increase](day-2/README.md#a-função-increase)
  ...
  - [A função avg_over_time](day-2/README.md#a-função-avg_over_time)
  - [A função sum_over_time](day-2/README.md#a-função-sum_over_time)
  - [A função max_over_time](day-2/README.md#a-função-max_over_time)
  - [A função min_over_time](day-2/README.md#a-função-min_over_time)
  - [A função stddev_over_time](day-2/README.md#a-função-stddev_over_time)
  - [A função by](day-2/README.md#a-função-by)
  - [A função without](day-2/README.md#a-função-without)
  - [A função histogram_quantile e quantile](day-2/README.md#a-função-histogram_quantile-e-quantile)
- [As nossas primeiras queries](day-2/README.md#as-nossas-primeiras-queries)
